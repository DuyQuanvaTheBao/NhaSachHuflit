...
namespace NhaSachHuflit.Areas.Admin.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        {
            ViewBag.OrderID = new SelectList(db.Order, "OrderID", "OrderName");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,OrderID,Price,Quantity,Status")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
